...
Page({
    ...
    storeInfo: function() {
        wx.showLoading({
            ...
            var a = t.data;
            1 == a.code ? (i.setData({
                storeInfo: t.data.data[0]
            }), i.mallUrlGen(), wx.hideLoading()) : (wx.showToast({
                title: a.msg,
    ...
    mallUrlGen: function() {
        ...
        t.request(a.home.store.mallUrlGen, {
            mall_id: i.data.mall_id,
            pid: e,
    ...
    onShareAppMessage: function(t) {
        ...
        var e = i.data.mall_id, s = i.data.storeInfo.mall_coupon_info_list.coupon_type, l = i.data.storeInfo.img_url, n = "/pages/main/storeDailyDetails/storeDailyDetails?mall_id=" + e + "&pid=" + a, d = "【" + i.data.storeInfo.mall_name + "】";

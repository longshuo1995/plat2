...
!function(o, t) {
    ...
    var D = require("C28BFE003FACD8FFA4ED960731CFC606.js"), b = "7.0.0", M = "log", P = "" + Date.now() + Math.floor(1e7 * Math.random()), R = "" + Date.now() + Math.floor(1e7 * Math.random()), I = "", T = 0, A = 0, U = "", L = "", k = "", q = 0, H = "", O = "", E = function() {
        var n = "";
        try {

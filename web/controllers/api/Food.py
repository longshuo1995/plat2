...
def get_pdd_url():
    ...
    if dt:
        ...
        resp['data'] = {
            ...
            'coupon_total_quantity': StrTools.null_convert(good_detail.get('coupon_total_quantity', 5000)),
            'coupon_remain_quantity': StrTools.null_convert(good_detail.get('coupon_remain_quantity', 3000)),
        }
